    ...
    public function run(): void
    {
        ...
        IntegrationConnection::query()->updateOrCreate(
            ...
            [
                ...
                'secret_last_rotated_at' => now()->subDays(12),
                'secret_rotation_due_at' => now()->addDays(18),
                'secret_expires_at' => now()->addDays(35),
                'scope_summary' => 'Ventes, tresorerie, stock et performance omnicanale.',
                'secret_notes' => 'Client OAuth pilote via coffre-fort et rotation mensuelle.',
        ...
        IntegrationConnection::query()->updateOrCreate(
            ...
            [
                ...
                'secret_owner_id' => $awa->id,
                'external_reference' => 'wave-callback-bamako',
                'last_sync_at' => now()->subHours(6),
                'last_health_at' => now()->subMinutes(45),
                'secret_last_rotated_at' => now()->subDays(28),
                'secret_rotation_due_at' => now()->addDays(3),
                'secret_expires_at' => now()->addDays(5),
                'scope_summary' => 'Notifications de paiement, rapprochement et tickets POS.',
                'secret_notes' => 'Secret callback a faire tourner avant le prochain week-end.',
        ...
        IntegrationConnection::query()->updateOrCreate(
            ...
            [
                ...
                'secret_health_status' => 'critical',
                'secret_owner_id' => $mamadou->id,
                'external_reference' => 'mw-stock-grossistes',
                'last_sync_at' => now()->subDays(2),
                'last_health_at' => now()->subHours(2),
                'secret_last_rotated_at' => now()->subDays(90),
                'secret_rotation_due_at' => now()->subDays(15),
                'secret_expires_at' => now()->subDays(2),
                'scope_summary' => 'Stocks, commandes B2B, statuts de livraison et reappro.',
                'secret_notes' => 'Secret historique a remplacer avant reprise du connecteur.',
