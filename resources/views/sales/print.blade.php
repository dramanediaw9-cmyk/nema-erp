...
@section('content')
    <section class="doc-header">
        ...
        <div class="right">
            ...
            <div class="meta">Workflow : {{ $invoice->status === 'validated' ? 'Approuvee' : ($invoice->status === 'cancelled' ? 'Annulee' : ($invoice->status === 'rejected' ? 'Rejetee' : 'En attente')) }}</div>
    ...
    <section class="grid grid-2">
        ...
        <div class="panel">
            ...
            <div><strong>Workflow :</strong> {{ $invoice->status === 'validated' ? 'Approuvee' : ($invoice->status === 'cancelled' ? 'Annulee' : ($invoice->status === 'rejected' ? 'Rejetee' : 'En attente d approbation')) }}</div>
            ...
            <div><strong>Rejetee par :</strong> {{ $invoice->rejector?->name ?? 'Non rejetee' }}</div>
