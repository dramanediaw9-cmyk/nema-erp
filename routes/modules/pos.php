...
Route::middleware(['auth', 'active', 'workspace'])->group(function (): void {
    ...
    Route::get('/point-de-vente/sessions', [PosBackofficeController::class, 'sessions'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.sessions.index');
    Route::get('/point-de-vente/paiements', [PosBackofficeController::class, 'payments'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.payments.index');
    Route::get('/point-de-vente/clients', [PosBackofficeController::class, 'customers'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.customers.index');
    Route::get('/point-de-vente/produits', [PosBackofficeController::class, 'products'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.products.index');
    Route::get('/point-de-vente/tarification', [PosBackofficeController::class, 'pricing'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.pricing.index');
    Route::get('/point-de-vente/analyse', [PosBackofficeController::class, 'analytics'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.analytics.index');
    ...
    Route::get('/point-de-vente/configuration', [PosBackofficeController::class, 'settings'])->middleware(['permission:pos.view', 'except_role:cashier'])->name('pos.settings.index');
    ...
    Route::get('/point-de-vente/sessions/{session}/imprimer', [PosController::class, 'printSession'])->middleware('permission:pos.view')->name('pos.session.print');
    ...
    Route::get('/point-de-vente/rapport-journalier/imprimer', [PosController::class, 'printReport'])->middleware('permission:pos.view')->name('pos.report.print');
    ...
    Route::get('/point-de-vente/vente/produits', [PosController::class, 'searchSaleProducts'])->middleware('permission:pos.manage')->name('pos.sales.products');
